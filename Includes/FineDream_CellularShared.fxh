...
uniform int FDREAM_CELL_PresetTier < ui_type = "combo"; ui_label = "Preset Tier"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 00 Driver"; ui_items = "Basic Conservative\0Liberal Coverage\0Aggressive Aggregate\0High Fidelity\0Ultra Fidelity\0"; ui_tooltip = "High Fidelity is the base standard; Ultra uses all bounded Lens55 taps without expanding cell-shader bodies."; > = 3;
...
uniform float FDREAM_CELL_MasterIntensity < ui_type = "slider"; ui_label = "Master Intensity"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 01 Main"; ui_min = 0.0; ui_max = 2.0; ui_step = 0.001; ui_tooltip = "Overall cell-shader strength multiplier."; > = 0.650000;
uniform float FDREAM_CELL_CelStrength < ui_type = "slider"; ui_label = "Cel Strength"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 01 Main"; ui_min = 0.0; ui_max = 2.0; ui_step = 0.001; ui_tooltip = "Blend amount of cel banding."; > = 0.650000;
uniform float FDREAM_CELL_EdgeStrength < ui_type = "slider"; ui_label = "Edge Strength"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 01 Main"; ui_min = 0.0; ui_max = 3.0; ui_step = 0.001; ui_tooltip = "Darkening amount for edge inking."; > = 0.520000;
uniform float FDREAM_CELL_SuperfineStrength < ui_type = "slider"; ui_label = "Superfine Strength"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 01 Main"; ui_min = 0.0; ui_max = 3.0; ui_step = 0.001; ui_tooltip = "Micro-detail enhancement for superfine drivers."; > = 0.620000;
uniform int FDREAM_CELL_CelBands < ui_type = "slider"; ui_label = "Cel Bands"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 02 Cel"; ui_min = 2; ui_max = 16; ui_step = 1; ui_tooltip = "Number of luminance bands used for cel quantization."; > = 8;
uniform float FDREAM_CELL_FineBandContrast < ui_type = "slider"; ui_label = "Fine Band Contrast"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 02 Cel"; ui_min = 0.0; ui_max = 2.0; ui_step = 0.001; ui_tooltip = "Contrast shaping for banded luminance."; > = 0.800000;
...
uniform float FDREAM_CELL_ChromaStability < ui_type = "slider"; ui_label = "Chroma Stability"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 05 Stability"; ui_min = 0.0; ui_max = 1.0; ui_step = 0.001; ui_tooltip = "Suppresses static tint by biasing stable superfine detail toward luminance."; > = 0.750000;
...
uniform int FDREAM_CELL_RaySteps < ui_type = "slider"; ui_label = "Ray Steps"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 06 Trace"; ui_min = 2; ui_max = 8; ui_step = 1; ui_tooltip = "Compact ray step budget. High Fidelity defaults to the full 8-step body."; > = 8;
...
uniform float FDREAM_CELL_LightProtectStrength < ui_type = "slider"; ui_label = "Light Protect Strength"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 09 Guards"; ui_min = 0.0; ui_max = 1.0; ui_step = 0.001; ui_tooltip = "How strongly protected lights return to source color."; > = 0.900000;
uniform float FDREAM_CELL_FogBypassCap < ui_type = "slider"; ui_label = "Fog Bypass Cap"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 09 Guards"; ui_min = 0.0; ui_max = 1.0; ui_step = 0.001; ui_tooltip = "Caps fog bypass so FD cell shading remains visible in fog-heavy scenes."; > = 0.850000;
