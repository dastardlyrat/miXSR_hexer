...
uniform float FDREAM_CELL_MasterIntensity < ui_type = "slider"; ui_label = "Master Intensity"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 01 Main"; ui_min = 0.0; ui_max = 2.0; ui_step = 0.001; ui_tooltip = "Overall cell-shader strength multiplier."; > = 1.376000;
uniform float FDREAM_CELL_CelStrength < ui_type = "slider"; ui_label = "Cel Strength"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 01 Main"; ui_min = 0.0; ui_max = 2.0; ui_step = 0.001; ui_tooltip = "Blend amount of cel banding."; > = 0.557000;
...
uniform float FDREAM_CELL_SuperfineStrength < ui_type = "slider"; ui_label = "Superfine Strength"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 01 Main"; ui_min = 0.0; ui_max = 3.0; ui_step = 0.001; ui_tooltip = "Micro-detail enhancement for superfine drivers."; > = 0.479000;
