...
// Version: RC-1
#ifndef MIXSR_FC_FOG_GATE_FXH
#define MIXSR_FC_FOG_GATE_FXH

#ifndef MIXSR_UI_FOG_CATEGORY
#define MIXSR_UI_FOG_CATEGORY "Fine Cell - Shared Fog Gate / 03 Unified Fog"
#endif

#ifndef MIXSR_UI_FOG_CLOSED
#define MIXSR_UI_FOG_CLOSED true
#endif

uniform int AIGX_FOG_Enable <
    ui_type = "combo";
    ui_label = "Enable Unified Fog Gate";
    ui_category = MIXSR_UI_FOG_CATEGORY; ui_category_closed = MIXSR_UI_FOG_CLOSED;
    ui_items = "No\0Yes\0";
> = 1;
...
uniform float AIGX_FOG_LowContrast <
    ...
    ui_category = MIXSR_UI_FOG_CATEGORY; ui_category_closed = MIXSR_UI_FOG_CLOSED;
    ui_min = 0.0; ui_max = 1.0000; ui_step = 0.00001;
> = 0.040000;
