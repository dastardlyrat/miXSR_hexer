...
uniform int FDREAM_CELL_PresetTier < ui_type = "combo"; ui_label = "Preset Tier"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 00 Driver"; ui_items = "Basic Conservative\0Liberal Coverage\0Aggressive Aggregate\0High Fidelity\0Ultra Fidelity\0"; ui_tooltip = "High Fidelity is the base standard; Ultra uses all bounded Lens55 taps without expanding cell-shader bodies."; > = 1;
uniform int FDREAM_CELL_DebugView < ui_type = "combo"; ui_label = "Debug View"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 08 Debug"; ui_items = "Final\0Cel\0Edge\0Hit Or Detail\0Depth Gate\0Ray Budget\0"; ui_tooltip = "Shows final output or diagnostic masks."; > = 1;
uniform float FDREAM_CELL_MasterIntensity < ui_type = "slider"; ui_label = "Master Intensity"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 01 Main"; ui_min = 0.0; ui_max = 2.33125; ui_step = 0.001; ui_tooltip = "Overall cell-shader strength multiplier."; > = 1.865000;
uniform float FDREAM_CELL_CelStrength < ui_type = "slider"; ui_label = "Cel Strength"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 01 Main"; ui_min = 0.0; ui_max = 2.5; ui_step = 0.001; ui_tooltip = "Blend amount of cel banding."; > = 2.000000;
uniform float FDREAM_CELL_EdgeStrength < ui_type = "slider"; ui_label = "Edge Strength"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 01 Main"; ui_min = 0.0; ui_max = 3.0; ui_step = 0.001; ui_tooltip = "Darkening amount for edge inking."; > = 0.387000;
uniform float FDREAM_CELL_SuperfineStrength < ui_type = "slider"; ui_label = "Superfine Strength"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 01 Main"; ui_min = 0.0; ui_max = 3.45; ui_step = 0.001; ui_tooltip = "Micro-detail enhancement for superfine drivers."; > = 2.397000;
...
uniform float FDREAM_CELL_FineBandContrast < ui_type = "slider"; ui_label = "Fine Band Contrast"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 02 Cel"; ui_min = 0.0; ui_max = 2.0; ui_step = 0.001; ui_tooltip = "Contrast shaping for banded luminance."; > = 0.000000;
uniform float FDREAM_CELL_RadiusPixels < ui_type = "slider"; ui_label = "bio Radius"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 03 Sampling"; ui_min = 0.25; ui_max = 18.4; ui_step = 0.01; ui_tooltip = "bio sample radius in screen pixels."; > = 11.750000;
uniform int FDREAM_CELL_TapCount < ui_type = "slider"; ui_label = "Tap Budget"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 03 Sampling"; ui_min = 4; ui_max = FDREAM_LENS55_TAP_COUNT; ui_step = 1; ui_tooltip = "Bounded Lens55 tap budget shared by broad, superfine, and --Ray-M cell-shader drivers."; > = 13;
uniform float FDREAM_CELL_EdgeRadiusPixels < ui_type = "slider"; ui_label = "Edge Radius"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 04 Edge"; ui_min = 0.25; ui_max = 10; ui_step = 0.01; ui_tooltip = "Sampling radius for edge detection."; > = 8.000000;
...
uniform float FDREAM_CELL_EdgeThreshold < ui_type = "slider"; ui_label = "Edge Threshold"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 04 Edge"; ui_min = 0.0; ui_max = 1.0; ui_step = 0.001; ui_tooltip = "Threshold where edge response starts."; > = 0.115000;
...
uniform float FDREAM_CELL_RayLengthPixels < ui_type = "slider"; ui_label = "Ray Length"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 06 Trace"; ui_min = 0.5; ui_max = 32.0; ui_step = 0.01; ui_tooltip = "Ray length in screen pixels for --Ray-M cell-shader drivers."; > = 9.930000;
uniform int FDREAM_CELL_RaySteps < ui_type = "slider"; ui_label = "Ray Steps"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 06 Trace"; ui_min = 2; ui_max = 8; ui_step = 1; ui_tooltip = "Compact ray step budget. High Fidelity defaults to the full 8-step body."; > = 2;
uniform float FDREAM_CELL_Thickness < ui_type = "slider"; ui_label = "Hit Thickness"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 06 Trace"; ui_min = 0.0001; ui_max = 0.125; ui_step = 0.0001; ui_tooltip = "Depth hit tolerance for --Ray-M drivers."; > = 0.100000;
uniform float FDREAM_CELL_DepthBias < ui_type = "slider"; ui_label = "Depth Bias"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 06 Trace"; ui_min = 0.0; ui_max = 0.1000; ui_step = 0.0001; ui_tooltip = "Self-hit bias for --Ray-M drivers."; > = 0.000000;
uniform float FDREAM_CELL_DepthFalloff < ui_type = "slider"; ui_label = "Depth Falloff"; ui_category = "Fine Cell - Cell Shading - Shared Driver / 06 Trace"; ui_min = 0.01; ui_max = 256.0; ui_step = 0.01; ui_tooltip = "Distance falloff shaping for ray contribution."; > = 87.610001;
