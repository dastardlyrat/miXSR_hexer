...
// Capability: Diagnostic fog gate and light shield first gate for true screen color, depth, fog, and light masks.
...
uniform int FDGATE_DebugView <
    ...
    ui_category = "Fine Cell - Fog and Light Gate - Shared First Gate Diagnostics / 00 Debug"; ui_category_closed = true;
    ui_items = "Diagnostic Tier Shading\0Locked Screen Color\0Screen Size\0Depth\0Fog Gate\0Light Shield\0Exclusion Zone\0Local Contrast\0";
...
technique fine_dream_Fog_Gate_and_Light_Shield_The_First_Gate < ui_label = "Fine Cell - Fog and Light Gate - Shared First Gate Diagnostics"; ui_tooltip = "Shared gate diagnostics: locked source, depth, fog gate, light shield, and exclusion-tier diagnostics."; >
{
